...
# Ellie Kerns
+1-406-670-9496 • ellie@epklabs.com •[Linkedin](linkedin.com/in/ellie-kerns-ab1328a0) • [epklabs.com](https://epklabs.com)	 
...
Windows, Windows Server, Microsoft Active Directory, Microsoft Azure, Powershell, Ubiquiti and Cisco networks, Avigilon building security systems, Redhat Linux, Ubuntu Server, Bash, PfSense, SQL, MySQL, Kubernetes, Docker, Portainer, VM-Ware, Proxmox, and Javascript.
